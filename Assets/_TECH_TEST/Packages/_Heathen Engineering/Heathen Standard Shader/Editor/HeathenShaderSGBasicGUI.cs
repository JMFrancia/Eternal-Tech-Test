...
{
internal class HeathenSGBasicShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static string projectionMode = "Mapping Mode";
	...
	MaterialProperty projectionMode = null;
	...
	//MaterialProperty zTestOcclusion = null;
	MaterialProperty cullFace = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		//zTestOcclusion = FindProperty ("_ZTest", props);
		cullFace = FindProperty ("_Cull", props);
	}
	...
	public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
	{
		...
		{
			case BlendMode.Opaque:
				material.SetOverrideTag("RenderType", "StandardGlow");
