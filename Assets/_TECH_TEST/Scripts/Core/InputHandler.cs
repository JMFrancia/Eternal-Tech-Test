...
public class InputHandler : Singleton<InputHandler>
{
    ...
    void Update()
    {
        ...
        if (_touches > 0)
        {
            ...
            if(_touches > maxTouches && maxTouches > 0) {
                LastPosition = (Input.GetTouch(_touches - 1)).position;
                lastDown = true;
            }
        }
        maxTouches = _touches;
...
#else
        pos = Position = LastPosition = Input.mousePosition;
